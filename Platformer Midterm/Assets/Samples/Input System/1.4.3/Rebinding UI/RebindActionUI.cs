            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        action.ApplyBindingOverride(0, action.bindings[0].overridePath);
                        action.Enable();
                        Debug.Log("New key is " + action.bindings[0].overridePath);
                        Debug.Log("Previous key is " + action.bindings[0].path);
                    }
